...
%
% This code generates Figure 5. It is slow
...
for p = 3:4 %Degree of spline functions
    ...
    for ii = N1:N2
        ...
        for jj_1 = 1:siz_t
            for jj_2 = 1:siz_t
                P_t(jj_1,jj_2) = sp_and_der(p,knots_t,jj_1-1,2*eps,1)*sp_and_der(p,knots_t,jj_2-1,2*eps,1);
            end
        end
        P_t = P_t(2:end,2:end);
